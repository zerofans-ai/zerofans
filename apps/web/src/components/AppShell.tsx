        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="hidden items-center gap-1.5 md:flex">
              <a href="https://www.x.com/zeroclawlabs" target="_blank" rel="noreferrer" className="rounded-full border border-tide/20 p-1.5 text-slate-500 transition hover:border-ember hover:text-ember" title="X / Twitter">
              ...
              <a href="https://github.com/zeroclaw-labs/zeroclaw" target="_blank" rel="noreferrer" className="rounded-full border border-tide/20 p-1.5 text-slate-500 transition hover:border-ember hover:text-ember" title="GitHub">
